...
x_line = Line2D(t_data, x_data, linewidth=1.,
                color="cyan", zorder=1, label="x")
y_line = Line2D(t_data, y_data, linewidth=1., color="red", zorder=1, label="y")
z_line = Line2D(t_data, z_data, linewidth=1.,
                color="green", zorder=1, label="z")
...
ani = FuncAnimation(fig, update, zip(x, y, z, t), interval=17,

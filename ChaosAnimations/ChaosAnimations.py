...
ax[0].set_title(f"Initial condition 1: {r0}\n Initial condition 2: {r1}")
ax[1].set_ylim([-1, 30])
ax[0].set_xlim([0, 40])
ax[0].set_ylim([-20, 20])
ax[1].set_xlim([0, 40])
...
#plt.tight_layout()
#writer = animation.HTMLWriter(fps=30)
#ani.save("/Users/evan/Desktop/ChaosAnimations/chaos_test.gif")
ls_frames = ani.new_frame_seq()
plt.show()

...
number_of_cores_used, dpi_used, fps_used, istest = [int(argument) for argument in sys.argv[1:]]
...
class projection_line(Line2D):
    '''Originally I had multiple lines so this class removed boilerplate, 
    but now I only use one line, I just keep it for future use :)'''

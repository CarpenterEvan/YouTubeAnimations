...
class Scope:
	def __init__(self, ax, dt):
		...
		self.line1 = Line2D(self.tdata, self.y1_data, linewidth=1., color="blue", zorder=1)
		self.line2 = Line2D(self.tdata, self.y2_data, linewidth=1., color="red", zorder=0)
		self.line3 = Line2D(self.tdata, self.y_diff, linewidth=1., color="purple")
...
ax[0].set_title(f"Initial Condition of Blue line: {r0}"+ "\n" + f"Initial Condition of Red line: {r1}")
